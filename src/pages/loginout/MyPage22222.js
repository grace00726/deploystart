          ...
          <div className="flex items-center mb-8 border-b border-gray-200 pb-6">
            ...
            <div className="relative mr-4">
              {!userData.profileImagePath ? (
                <div
                  className="w-24 h-24 rounded-full bg-gray-100 border-2 border-orange-200 flex items-center justify-center cursor-pointer shadow-sm"
                  onClick={handleImageClick}
                >
                  <svg
                    className="w-20 h-20 text-gray-400 -translate-y-1"
                    viewBox="0 0 100 100"
                ...
                <img
                  ...
                  alt="프로필 사진"
                  className="w-24 h-24 rounded-full object-cover border-2 border-orange-200 shadow-sm cursor-pointer"
                  onClick={handleImageClick}
                />
              )}
              {loading && (
            ...
            <div className="flex-1">
              <h2 className="text-2xl font-bold text-orange-500 mb-1 select-none">
                마이페이지
              </h2>
              ...
              <p className="text-sm text-gray-600">
                {userData.userId} | {userData.userEmail}
              </p>
            </div>
          ...
          <nav className="select-none space-y-4">
            {sidebar.map((category) => (
              <div key={category.id} className="mb-4">
                <h3 className="text-sm uppercase tracking-wider text-gray-500 font-semibold mb-2 pl-4">
                  {category.label}
                </h3>
